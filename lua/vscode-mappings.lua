...
map("n", "<leader>N", "<CMD>lua Snacks.picker.notifications()<CR>", { desc = "Notifications" })
map("n", "<leader>C", "<CMD>lua Snacks.picker.files({cwd = vim.fn.stdpath('config')})<CR>", { desc = "Nvim Config" })
